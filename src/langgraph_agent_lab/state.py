...
class AgentState(TypedDict, total=False):
    ...
    Append-only audit fields use ``operator.add`` reducers. Scalar workflow decisions overwrite
    their previous value so conditional routes always observe the current decision.
    """
